						...
						<div class="row g-4">
							<div class="col-sm-12 col-md-8 d-flex align-items-center">
								...
								<div class="text-start ps-4">
									<h5 class="mb-3">${job.getJobName()}</h5>
									<span class="text-truncate me-3"><i
										class="fa fa-map-marker-alt text-primary me-2"></i>${job.getJobLocation() }</span> <span class="text-truncate me-3"><i
										class="far fa-clock text-primary me-2"></i>${job.getJobType() }</span> <span
										class="text-truncate me-0"><i
										class="far fa-money-bill-alt text-primary me-2"></i>${job.getJobPackage() }</span>
								</div>
							</div>
							<div
								...
								<small class="text-truncate"><i
									class="far fa-calendar-alt text-primary me-2"></i>Date Line: ${job.getJobEndingDate() }</small>
							</div>
						</div>
					</div>
					</c:forEach>
